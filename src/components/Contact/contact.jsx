...
<div className="right">
    ...
    <input type="text" placeholder="Subject" name="user_subject"/>
        <input type="text" placeholder="Email" name="user_email" onChange={(e)=>{setEmail(e.target.value)}}/>
        <textarea placeholder="Message" name="message" onChange={(e)=>setMes(e.target.value)}></textarea>
